...
#list=(MassLimit/new_a3_w9.1_n0.2/y3x50 MassLimit/new_a3_w9.1_n0.2/y3x100 MassLimit/new_a3_w9.1_n0.2/y3x200 MassLimit/new_a3_w9.1_n0.2/y3x300)
list=(45TW/new_a3_n0.29_half)
...
for i in ${list[@]};
    do
        python gifKpolar.py $i
        python gifKThetaMax.py $i
        #python gifBzDensity.py $i
        #python multitest.py $i

...
list=(MassLimit/tracer/y3x250 MassLimit/tracer/y5x250 MassLimit/tracer/y7x250 MassLimit/tracer/y30x250 MassLimit/tracer/y50x250 MassLimit/tracer/y10x250 MassLimit/tracer/y120x250)

for i in ${list[@]};
    do
        #python getTimeSequence.py $i 50e-6  #$x #$y

        python ScreenTHz.py $i

        #python getTimeSequence.py $i 140e-6

        #python EffFinal.py $i 60e-6

        python EffScreen.py $i

        #python EffFinal.py $i 140e-6

        #python plotFinalTHz.py $i 60e-6

        python plotScreenTHz.py $i

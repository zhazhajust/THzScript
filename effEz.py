...
savefigdir = const.figdir + 'EzThz' + 'Efficiency2d.png'
...
def draw(x):
    ...
    ####savedir###
    savedir = pngdir + 'F' + str(x) + 'Ezfilter.jpg'
...
np.save(const.txtdir + 'EffEz.npy',efficiency)
...
np.save(const.txtdir + 'EffLocateEz.npy',locate)

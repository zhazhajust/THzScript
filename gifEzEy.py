...
###
	...
	im=axs[0][0].pcolormesh(bz.T*3e8,cmap=plt.get_cmap('bwr'))   
	im2=axs[1][1].pcolormesh(ne)
	im3=axs[0][1].pcolormesh(bz_filter.real.T*3e8,cmap=plt.get_cmap('bwr'))
	...
	im4=axs[1][0].pcolormesh((Ex.data).T,cmap=plt.get_cmap('bwr'))
...
def main():
    ...
    gif_name = const.gifdir + "bz_thz.gif"
    duration = 0.2

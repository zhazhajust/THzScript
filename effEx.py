...
savefigdir = const.figdir + 'ExThz' + 'Efficiency2d.png'
...
def draw(x):
    ...
    ####savedir###
    savedir = pngdir + 'F' + str(x) + 'Exfilter.jpg'
...
np.save(const.txtdir + 'EffEx.npy',efficiency)
...
np.save(const.txtdir + 'EffLocateEx.npy',locate)
